...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-authorization" &&
                "${module_path}" != github.com/faustbrian/go-authorization/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-authorization"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
